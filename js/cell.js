class Cell {
  ...
  mitosis() {
    let daughterCellZ = this.z + 1;
    let daughterCell = new Cell(this.x, this.y, daughterCellZ, 1.0, 1.0, 1.0);
    return daughterCell;
  }
  ...
  cellProperty() {
    this.cellEnergy = getRandomArbitrary(10, 30);
    this.divisionEnergy = getRandomArbitrary(30, 100);
